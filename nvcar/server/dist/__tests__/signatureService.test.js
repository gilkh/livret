...
describe('signatureService', () => {
    ...
    it('unsign removes signature and reverts status when no remaining signatures', async () => {
        ...
        await TemplateSignature_1.TemplateSignature.create({ templateAssignmentId: String(assignment._id), subAdminId: String(signer._id), type: 'standard', status: 'signed', signaturePeriodId: `${String(sy._id)}_sem1`, schoolYearId: String(sy._id) });
